...
public class GameRenderTask implements RenderTask {
    ...
    //Function that will render the bottom bar, score, and trophy / unpause buttons.
    private void renderUI(Canvas canvas, int score) {
        ...
        paint.setTextSize(canvas.getHeight() * 0.1f);
        canvas.drawText("Score: " + score, left, top, paint);
    }
